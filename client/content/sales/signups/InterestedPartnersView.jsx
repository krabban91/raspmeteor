...
class InterstedPartnersView extends Component {

	renderPartnersTable(partners, title){
		return (
	    ...
	    return (
			<div className="container">
				...
				{this.props.potentialPartners && this.props.potentialPartners.length>0?
					this.renderPartnersTable(this.props.potentialPartners, "Intressenter ("+this.props.potentialPartners.length + "st)"):''}
		        </div>
			</div>
		);
	}
